...
class ImageFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create image_file" do
    assert_difference('ImageFile.count') do
      post image_files_url, params: { image_file: { comment: @image_file.comment, file_name: @image_file.file_name, user_id: @image_file.user_id } }
    end
  ...
  test "should update image_file" do
    patch image_file_url(@image_file), params: { image_file: { comment: @image_file.comment, file_name: @image_file.file_name, user_id: @image_file.user_id } }
