...
class UserPagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_page" do
    assert_difference('UserPage.count') do
      post user_pages_url, params: { user_page: { page_id: @user_page.page_id, user_id: @user_page.user_id } }
    end
  ...
  test "should update user_page" do
    patch user_page_url(@user_page), params: { user_page: { page_id: @user_page.page_id, user_id: @user_page.user_id } }
